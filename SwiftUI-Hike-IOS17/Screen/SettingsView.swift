    ...
    var body: some View {
        List {
            ...
            Section (header: Text("Alternate Icons")) {
                ...
                Text("Choose your favorite app icon from the callection above.")
...
//                LabeledContent("Application", value: "Hike")
                ...
                CustomListRowView(rowLabel: "Developer", rowIcon: "paintpalette", rowContent: "Danfelogar", rowTinColor: .mint)
                
                CustomListRowView(rowLabel: "Website", rowIcon: "globe", rowContent: nil, rowTinColor: .indigo, rowLinkLabel: "Danfelogar Web", rowLinkDestination: "https://github.com/Danfelogar")
